...
export const roomSetups: RoomSetup[] = [
  {
    ...
    props: ['wall-clock', 'old-desk', 'mirror', 'candle', 'newspaper', 'diary']
  },
  {
    id: 'radio-station',
    name: '电台直播间',
    description: '废弃的广播电台，设备布满灰尘',
    props: ['radio', 'tape-recorder', 'phonograph', 'microphone', 'headphone', 'console']
  },
  {
    id: 'temple',
    name: '荒村祠堂',
    description: '年久失修的祠堂，香案上散落着符纸',
    props: ['talisman', 'candle', 'lantern', 'lockbox', 'photo', 'mask']
  },
  {
    id: 'basement',
    name: '地下室',
    description: '阴暗潮湿的地下室，铁门上挂着锁',
    props: ['padlock', 'combination-lock', 'lockbox', 'flashlight', 'key', 'blacklight']
  },
  {
    id: 'study',
    name: '书房',
    description: '神秘学者的书房，书架上堆满古籍',
    props: ['old-desk', 'diary', 'newspaper', 'lockbox', 'candle', 'compass']
  }
]
